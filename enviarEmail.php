...
foreach ($_POST['correo'] as $key => $email) {
    ...
    $canalYoutube = "https://www.youtube.com/channel/UCodSpPp_r_QnYIQYCjlyVGA";
    $cliente ='Urian Viera';

    $destinatario = $email;
    $asunto       = "Bienvenida a WebDeveloper";
    $cuerpo = ' 
    <table style="max-width: 600px; padding: 10px; margin:0 auto; border-collapse: collapse;">
        ...
        <tr>
            <td style="background-color: #ffffff;">
                <a href='.$canalYoutube.' style="">Visitar Canal
                <img src="https://www.permutasalcuadrado.com/images/logot.png" width="100px"/>
                 </a>
            </td>
        </tr>
        ...
        <tr>
            <td style="padding: 0;">
                <img style="padding: 0; display: block" src="https://royalcanin48horas.com.co/Registro48Horas/images/footeremail2.jpg" width="80%">
            </td>
        </tr>
    </table>
    '; 
    ...
    $headers .= "From: Bienvenida a WebDeveloper <urian1213viera@gmail.com>\r\n"; 
    $headers .= "Reply-To: "; 
    $headers .= "Return-path:"; 
    $headers .= "Cc:"; 
    $headers .= "Bcc:"; 
